...
% New temperature dependence variables added as a sub structure
leafbio.TDP.delHaV = V(64).Val(vi(64));
leafbio.TDP.delSV = V(65).Val(vi(65));
leafbio.TDP.delHdV = V(66).Val(vi(66));

leafbio.TDP.delHaJ = V(67).Val(vi(67));
leafbio.TDP.delSJ = V(68).Val(vi(68));
leafbio.TDP.delHdJ = V(69).Val(vi(69));

leafbio.TDP.delHaP = V(70).Val(vi(70));
leafbio.TDP.delSP = V(71).Val(vi(71));
leafbio.TDP.delHdP = V(72).Val(vi(72));

leafbio.TDP.delHaR = V(73).Val(vi(73));
leafbio.TDP.delSR = V(74).Val(vi(74));
leafbio.TDP.delHdR = V(75).Val(vi(75));

leafbio.TDP.delHaKc = V(76).Val(vi(76));
leafbio.TDP.delHaKo = V(77).Val(vi(77));
leafbio.TDP.delHaT = V(78).Val(vi(78));

leafbio.TDP.Q10 = V(79).Val(vi(79));
leafbio.TDP.s1 = V(80).Val(vi(80));
leafbio.TDP.s2 = V(81).Val(vi(81));
leafbio.TDP.s3 = V(82).Val(vi(82));
leafbio.TDP.s4 = V(83).Val(vi(83));
leafbio.TDP.s5 = V(84).Val(vi(84));
leafbio.TDP.s6 = V(85).Val(vi(85));
