...
fprintf(fidf,'%9.0f %9.0f %9.0f %9.4f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.2f %9.4f %9.4f %9.4f',...
    [k iter.counter xyt.year(k) xyt.t(k) fluxes.Rntot fluxes.lEtot fluxes.Htot fluxes.Rnctot fluxes.lEctot, ...
    fluxes.Hctot fluxes.Actot fluxes.Rnstot fluxes.lEstot fluxes.Hstot fluxes.Gtot fluxes.Resp 1E6*fluxes.aPAR  1E6*fluxes.aPAR_Cab fluxes.aPAR/rad.PAR fluxes.aPAR_Wm2 1E6*rad.PAR fluxes.can_cond fluxes.can_cond_gs fluxes.Agtot]);
...
if options.calc_vert_profiles
    ...
    if options.calc_ebal
        ...
        % DD added 10.10.2017
        fidphPSII           = fopen([Output_dir,'layer_phPSII.dat'],'a');
        fprintf(fidphPSII,'%9.4f',[profiles.phPSII' 0]);
        fprintf(fidphPSII,'\r');
        %
